---
title: Meilensteinleitfaden
description: In vier Meilensteinen zur fertigen IHK-Prüfungspräsentation
---
...
```mermaid
flowchart LR
    A["MS 1<br>Thema &<br>Ausgangslage"] --> B["MS 2<br>Analyse &<br>Vorgehen"]
    B --> C["MS 3<br>Ergebnis &<br>Reflexion"]
    C --> D["MS 4<br>Präsentation<br>erstellen"]
```
